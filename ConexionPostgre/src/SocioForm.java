...
public class SocioForm extends JFrame {
    ...
    JTextField tfUbicacion = new JTextField(15);
    ...
    public SocioForm() {
        ...
        panelRegistro.add(new JLabel("Ubicación ID:"));
        panelRegistro.add(tfUbicacion);
    ...
    void iniciarOperacion(String op) {
        ...
        if (!op.equals("adicionar")) {
            ...
            tfUbicacion.setText(modelo.getValueAt(fila, 7).toString());
    ...
    void actualizar() {
        try (Connection conn = ConexionDB.conectar()) {
            ...
            if (operacion.equals("adicionar") || operacion.equals("modificar")) {
                ...
                ps.setInt(7, Integer.parseInt(tfUbicacion.getText()));
