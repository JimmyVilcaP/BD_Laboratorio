...
public class CooperativaForm extends JFrame {
    ...
    public CooperativaForm() {
        ...
        panelForm.add(new JLabel("Identificador:")); panelForm.add(tfIden);
        panelForm.add(new JLabel("Nombre:")); panelForm.add(tfNombre);
        panelForm.add(new JLabel("Sigla:")); panelForm.add(tfSigla);
        panelForm.add(new JLabel("Dirección:")); panelForm.add(tfDireccion);
        panelForm.add(new JLabel("Teléfono:")); panelForm.add(tfTelefono);
        panelForm.add(new JLabel("Correo:")); panelForm.add(tfCorreo);
        panelForm.add(new JLabel("Usuario:")); panelForm.add(tfUsuario);
        panelForm.add(new JLabel("Logo:"));
        JPanel logoPanel = new JPanel(new BorderLayout());
        lblLogo.setPreferredSize(new Dimension(120, 60));
        lblLogo.setBorder(BorderFactory.createLineBorder(Color.GRAY));
        logoPanel.add(lblLogo, BorderLayout.CENTER);
        logoPanel.add(btnCargarLogo, BorderLayout.SOUTH);
        panelForm.add(logoPanel);
        ...
        btnCargarLogo.addActionListener(e -> {
            ...
            if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                lblLogo.setIcon(new ImageIcon(new ImageIcon(rutaLogo).getImage().getScaledInstance(120, 60, Image.SCALE_SMOOTH)));
            }
        });
